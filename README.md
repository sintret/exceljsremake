...
[![Build Status](https://github.com/sintret/exceljsremake/actions/workflows/tests.yml/badge.svg?branch=master&event=push)](https://github.com/sintret/exceljsremake/actions/workflows/tests.yml)
...
This project is a community-maintained fork of the original [`exceljs`](https://github.com/exceljs/exceljs) project (MIT licensed).

- **NPM package name**: `exceljsremake` (API usage remains `ExcelJS`)
- **License**: MIT (see `LICENSE`)
- **Upstream project**: [`exceljs/exceljs`](https://github.com/exceljs/exceljs)
...
For changes specific to `exceljsremake`, see this repository's releases and commits:

- GitHub releases: https://github.com/sintret/exceljsremake/releases
- Compare changes: https://github.com/sintret/exceljsremake/compare

For upstream history of the original project, see:

- Upstream repo: https://github.com/exceljs/exceljs
- Upstream releases: https://github.com/exceljs/exceljs/releases
...
**Note:** The ES5 build has an implicit dependency on a number of polyfills which are no longer
 ...
 include the following requires in your code before the exceljsremake import:

```javascript
// polyfills required by exceljsremake
...
# Release History (upstream)

Release history from the upstream `exceljs` project is kept in [`UPSTREAM_HISTORY.md`](UPSTREAM_HISTORY.md) to keep this README short.
